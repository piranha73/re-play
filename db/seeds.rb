...
#Tournament Seeds
Tournament.create(name: "Champions League", location: "Madrid, Spain", description: "Great tournament!", number_of_teams: 5, number_of_players_per_team: 5, price: 1000, sport_id: 1, user_id: 1, structure_id: 1, optional_id: 1)
Tournament.create(name: "Europa League", location: "Milan, Italy", description: "Good tournament!", number_of_teams: 4, number_of_players_per_team: 2, price: 800, sport_id: 1, user_id: 2, structure_id: 1, optional_id: 1)
Tournament.create(name: "Players League", location: "Paris, France", description: "Nice tournament!", number_of_teams: 3, number_of_players_per_team: 3, price: 700, sport_id: 1, user_id: 3, structure_id: 1, optional_id: 1)
Tournament.create(name: "Cool League", location: "London, UK", description: "Cool tournament!", number_of_teams: 2, number_of_players_per_team: 5, price: 600, sport_id: 1, user_id: 4, structure_id: 1, optional_id: 1)
Tournament.create(name: "Pro League", location: "Berlin, Germany", description: "Well-organized tournament!", number_of_teams: 4, number_of_players_per_team: 1, price: 500, sport_id: 1, user_id: 1, structure_id: 1, optional_id: 1)
