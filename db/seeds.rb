...
#Tournament Seeds
Tournament.create(name: "Champions League", location: "Madrid, Spain", description: Faker::Lorem.paragraphs(number: 7), number_of_teams: 5, number_of_players_per_team: 5, price: 1000, sport_id: 1, user_id: 1, structure_id: 1, start_time: Faker::Date.forward(days: 55) , end_time: Faker::Date.forward(days: 60))
Tournament.create(name: "Europa League", location: "Milan, Italy", description: Faker::Lorem.paragraphs(number: 7), number_of_teams: 4, number_of_players_per_team: 2, price: 800, sport_id: 1, user_id: 2, structure_id: 1, start_time: Faker::Date.forward(days: 2) , end_time: Faker::Date.forward(days: 5))
Tournament.create(name: "Players League", location: "Paris, France", description: Faker::Lorem.paragraphs(number: 7), number_of_teams: 3, number_of_players_per_team: 3, price: 700, sport_id: 1, user_id: 3, structure_id: 1, start_time: Faker::Date.forward(days: 7) , end_time: Faker::Date.forward(days: 11))
Tournament.create(name: "Cool League", location: "London, UK", description: Faker::Lorem.paragraphs(number: 7), number_of_teams: 7, number_of_players_per_team: 5, price: 600, sport_id: 1, user_id: 4, structure_id: 1,start_time: Faker::Date.forward(days: 3) , end_time: Faker::Date.forward(days: 6))
Tournament.create(name: "Pro League", location: "Berlin, Germany", description: Faker::Lorem.paragraphs(number: 7), number_of_teams: 8, number_of_players_per_team: 2, price: 500, sport_id: 1, user_id: 1, structure_id: 1, start_time: Faker::Date.forward(days: 23) , end_time: Faker::Date.forward(days: 27))
